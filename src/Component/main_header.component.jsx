    ...
    return (
      <div className="min-w-full w-full h-screen bg-gradient-to-b from-green-100 via-green-100">
        ...
        <div className="relative h-4/5 w-full flex justify-center">
          <div className="absolute right-0 top-12 opacity-0 sm:opacity-80 overflow-hidden">
            <img className="leaf1" src={leaves} alt="leaves1" />
          </div>
          <div className="absolute left-0 top-60 opacity-0 sm:opacity-80">
            <img
              className="transform rotate-90 leaf2"
              src={leaves2}
              alt="leaves2"
            />
          </div>
          <div className="w-3/5 flex flex-col my-auto">
            <span className="text-gray-900 sm:text-gray-800 font-sans text-4xl sm:text-7xl font-bold text-center sm:leading-normal sm:p-6 pb-4">
